...
<html>
    <head>
		...
		})(window,document,'script','dataLayer','GTM-5KX8PGH');</script>
        ...
        <link rel="stylesheet" type="text/css" href="style/howItWork.css" />
        ...
        <link rel="stylesheet" type="text/css" href="style/mobile/howItWorkMobile.css" />
        ...
        <link rel="stylesheet" type="text/css" href="style/tablet/howItWorkTablet.css" />
        ...
        <link rel="stylesheet" type="text/css" href="style/desktop/howItWorkDesktop.css" />
    ...
    <body>
		...
		<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5KX8PGH"
        ...
        <div class="allBody">
            ...
            <div class="header">
                <ul id="toolbar" class="toolbar">
                    ...
                    <li class="menuItem1 bar"><a href="howItWork.php">наш сервис</a></li>
...
<!--                    <div id="filterDogIcon" class="filterDogIcon"></div>-->
                    ...
                    <div class="pageInfoGroup">
                        <div class="numberCicle">
                            <span class="infoGroupNumber">1</span>
                        </div>
                ...
                <div class="slide2Body">
                    ...
                    <div class="line2">
                        ...
                        <div class="phoneWithTelematic"></div>
                    </div>
                </div>
                <div class="slide3Body">
                    <div class="pageInfoGroup">
                        <div class="numberCicle">
                            <span class="infoGroupNumber">3</span>
                        </div>
                        <div class="groupTitle">
                    ...
                    <div class="elseOptionsTitle">
                        <span>
                            Дополнительные возможности
                        </span>
                    </div>
                    <div class="elseOptionsSlide">
                    </div>
                    <div class="slideShow">
                        <div class="leftButtonItem">
                            <div id="leftButton" class="button"></div>
                        </div>
                        <div class="slideShowItem">
                            <div class="phone" >
                                <div class="phoneDisplay owl-carousel">
                            ...
                            <div class="sliderTabs">
                                <div id="slideBar1" class="tab active"></div>
                                <div id="slideBar2" class="tab"></div>
                            ...
                            <div class="addGroupInfo">
                                ...
                                <div class="addGroupInfoItem">
                                    <span class="itemDot"></span>
                                    <span class="itemInfo">дистанцию,</span>
                                </div>
                                <div class="addGroupInfoItem">
                                    <span class="itemDot"></span>
            ...
            <script src="script/howItWorkPage.js" ></script>
        </div>
